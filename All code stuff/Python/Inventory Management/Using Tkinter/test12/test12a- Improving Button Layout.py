...
refresh_button = tk.Button(button_frame, text="Refresh Inventory", command=show_inventory, bg="#2196F3", fg="white")
...
# Sort by Name Button
sort_name_button = tk.Button(button_frame, text="Sort by Name", command=sort_inventory, bg="#9C27B0", fg="white")
sort_name_button.grid(row=2, column=0, padx=5)
...
sort_quantity_button = tk.Button(button_frame, text="Sort by Quantity (Ascending)", command=sort_inventory_by_quantity, bg="#9C27B0", fg="white")
sort_quantity_button.grid(row=2, column=1, padx=5)
...
# Save Report Button
save_report_button = tk.Button(button_frame, text="Save Report", command=save_report, bg="#4CAF50", fg="white")
save_report_button.grid(row=3, column=0, padx=5)
...
close_button = tk.Button(button_frame, text="Close", command=close_application, bg="#F44336", fg="white")
