...
class InventoryApp(QMainWindow):
    def __init__(self):
        ...
        self.update_product_button.setStyleSheet("background-color: #FFB300; color: white;")  # Yellowish
        ...
        self.save_button.setStyleSheet(f"background-color: blue; color: white;")  # Random color
