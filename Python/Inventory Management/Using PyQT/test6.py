...
class InventoryApp(QMainWindow):
    def __init__(self):
        ...
        self.add_product_button.setStyleSheet("background-color: green; color: white;")  # Green button
        self.add_product_button.setFont(QFont("Segoe UI", 12, weight=QFont.Bold))  # Bold font
        ...
        self.update_product_button.setStyleSheet("background-color: #FFAA00; color: white;")  # Darker Yellow
        self.update_product_button.setFont(QFont("Segoe UI", 12, weight=QFont.Bold))  # Bold font
        ...
        self.search_button.setFont(QFont("Segoe UI", 12, weight=QFont.Bold))  # Bold font
        ...
        self.sort_name_button.setStyleSheet("background-color: magenta; color: white;")  # Magenta
        self.sort_name_button.setFont(QFont("Segoe UI", 12, weight=QFont.Bold))  # Bold font
        self.sort_name_button.clicked.connect(lambda: self.sort_inventory("name"))
        
        self.sort_asc_button = QPushButton("Sort Ascending")
        self.sort_asc_button.setStyleSheet("background-color: magenta; color: white;")  # Magenta
        self.sort_asc_button.setFont(QFont("Segoe UI", 12, weight=QFont.Bold))  # Bold font
        self.sort_asc_button.clicked.connect(lambda: self.sort_inventory("asc"))

        self.sort_desc_button = QPushButton("Sort Descending")
        self.sort_desc_button.setStyleSheet("background-color: magenta; color: white;")  # Magenta
        self.sort_desc_button.setFont(QFont("Segoe UI", 12, weight=QFont.Bold))  # Bold font
        ...
        self.delete_product_button.setStyleSheet("background-color: red; color: white;")  # Red button
        self.delete_product_button.setFont(QFont("Segoe UI", 12, weight=QFont.Bold))  # Bold font
        self.delete_product_button.clicked.connect(self.delete_product)

        self.save_button = QPushButton("Save to CSV")
        self.save_button.setStyleSheet(f"background-color: blue; color: white;")  # Blue button
        self.save_button.setFont(QFont("Segoe UI", 12, weight=QFont.Bold))  # Bold font
    ...
    def sort_inventory(self, order):
        ...
        if order == "name":
            self.c.execute("SELECT name, quantity FROM products ORDER BY name")
        elif order == "asc":
    ...
    def closeEvent(self, event):
        self.conn.close()  # Close database connection when the application is closed
        event.accept()
