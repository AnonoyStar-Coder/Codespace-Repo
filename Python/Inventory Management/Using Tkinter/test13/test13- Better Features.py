...
update_product_button = tk.Button(button_frame, text="Update Product", command=update_product, bg="#FF9800", fg="white")
update_product_button.grid(row=1, column=0, padx=5)
