...
root.geometry("600x400")  # Increased width for better layout
...
# Inventory Display
inventory_listbox = tk.Listbox(output_frame, width=40, height=15)
...
sort_quantity_button = tk.Button(input_frame, text="Sort by Quantity", command=sort_inventory_by_quantity, bg="#9C27B0", fg="white")
