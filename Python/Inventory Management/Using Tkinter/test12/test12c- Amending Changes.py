...
save_report_button.grid(row=2, column=0, pady=5)
...
# Refresh Button
refresh_button = tk.Button(button_frame, text="Refresh", command=refresh_inventory, bg="#2196F3", fg="white")
...
close_button.grid(row=2, column=2, padx=5)
